...
HD_PWD='D:/my_homework/my_vivado_practice/DDSwave_geneator/dds_wave_generator/dds_wave_generator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_dds.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_dds.tcl -notrace
