...
HD_PWD='D:/my_homework/my_vivado_practice/DDSwave_geneator/dds_wave_generator/dds_wave_generator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_dds.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_dds.tcl
