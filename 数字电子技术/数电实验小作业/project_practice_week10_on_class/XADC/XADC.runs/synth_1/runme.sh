...
HD_PWD='D:/my_homework/my_vivado_practice/project_practice_week10_on_class/XADC/XADC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_XADC_voltage.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_XADC_voltage.tcl
