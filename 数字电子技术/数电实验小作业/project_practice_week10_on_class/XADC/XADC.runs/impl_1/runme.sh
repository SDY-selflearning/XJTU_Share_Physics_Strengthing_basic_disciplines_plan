...
HD_PWD='D:/my_homework/my_vivado_practice/project_practice_week10_on_class/XADC/XADC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_XADC_voltage.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_XADC_voltage.tcl -notrace
