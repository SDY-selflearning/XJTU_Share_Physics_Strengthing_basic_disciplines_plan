...
HD_PWD='D:/my_homework/my_vivado_practice/project_practice_week7_on_class/vote_agree_mux/vote_agree_mux.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vo_ag_mu_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vo_ag_mu_top.tcl -notrace
