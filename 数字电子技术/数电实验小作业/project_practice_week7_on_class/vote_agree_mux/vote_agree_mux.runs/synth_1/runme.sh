...
HD_PWD='D:/my_homework/my_vivado_practice/project_practice_week7_on_class/vote_agree_mux/vote_agree_mux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vo_ag_mu_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vo_ag_mu_top.tcl
