...
HD_PWD='D:/my_homework/my_vivado_practice/DAC0832/DAC0832/DAC0832.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_DAC0832.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_DAC0832.tcl
