...
HD_PWD='D:/my_homework/my_vivado_practice/DAC0832/DAC0832/DAC0832.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_DAC0832.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_DAC0832.tcl -notrace
