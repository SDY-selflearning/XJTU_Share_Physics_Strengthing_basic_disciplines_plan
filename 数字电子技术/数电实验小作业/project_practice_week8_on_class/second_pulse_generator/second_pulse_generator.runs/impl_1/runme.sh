...
HD_PWD='D:/my_homework/my_vivado_practice/project_practice_week8_on_class/second_pulse_generator/second_pulse_generator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log second_pulse_generator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source second_pulse_generator.tcl -notrace
