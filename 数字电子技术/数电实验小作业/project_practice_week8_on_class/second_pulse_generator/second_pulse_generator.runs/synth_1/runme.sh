...
HD_PWD='D:/my_homework/my_vivado_practice/project_practice_week8_on_class/second_pulse_generator/second_pulse_generator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log second_pulse_generator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source second_pulse_generator.tcl
