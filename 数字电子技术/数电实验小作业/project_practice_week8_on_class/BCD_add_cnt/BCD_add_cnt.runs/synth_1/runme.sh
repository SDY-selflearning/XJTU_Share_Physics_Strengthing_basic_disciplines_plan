...
HD_PWD='D:/my_homework/my_vivado_practice/project_practice_week8_on_class/BCD_add_cnt/BCD_add_cnt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_cnt_digit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BCD_cnt_digit.tcl
