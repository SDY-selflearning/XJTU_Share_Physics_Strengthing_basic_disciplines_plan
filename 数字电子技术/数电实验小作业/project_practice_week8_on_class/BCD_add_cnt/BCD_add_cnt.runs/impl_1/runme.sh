...
HD_PWD='D:/my_homework/my_vivado_practice/project_practice_week8_on_class/BCD_add_cnt/BCD_add_cnt.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_cnt_digit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BCD_cnt_digit.tcl -notrace
