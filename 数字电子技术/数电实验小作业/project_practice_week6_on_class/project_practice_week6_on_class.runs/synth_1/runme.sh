...
HD_PWD='D:/my_homework/my_vivado_practice/project_practice_week6_on_class/project_practice_week6_on_class.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log and_or_not.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source and_or_not.tcl
