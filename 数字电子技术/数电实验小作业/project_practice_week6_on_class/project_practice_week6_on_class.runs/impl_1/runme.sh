...
HD_PWD='D:/my_homework/my_vivado_practice/project_practice_week6_on_class/project_practice_week6_on_class.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log and_or_not.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source and_or_not.tcl -notrace
